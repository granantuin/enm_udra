# -*- coding: utf-8 -*-
"""
Created on Sun Sep 25 16:04:08 2022
...
lat_station = 42.3394 #@param {type:"number"}
lon_station = -8.8339 #@param {type:"number"}
n_nearest =  10#@param {type:"integer"}
forecast_D = 1 #@param ["0", "1", "2", "3"] {type:"raw"}
initial_day_YYYYMMDD = "20210311" #@param {type:"raw"}
final_day_YYYYMMDD = "20210319" #@param {type:"raw"}
...
df=xr.open_dataset(urlretrieve(url)[0],).to_dataframe()
