# -*- coding: utf-8 -*-
"""
Created on Sun Sep 25 10:16:07 2022
...
lat_station = 42.39707 #@param {type:"number"}
lon_station = -8.69362 #@param {type:"number"}
n_nearest =  4#@param {type:"integer"}
forecast_D = 1 #@param ["0", "1", "2", "3"] {type:"raw"}
initial_day_YYYYMMDD = "20210311" #@param {type:"raw"}
final_day_YYYYMMDD = "20210318" #@param {type:"raw"}
